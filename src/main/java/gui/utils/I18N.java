...
public abstract class I18N {
    ...
    public static List<Locale> getSupportedLocales() {
        return new ArrayList<>(Arrays.asList(new Locale("eng"), new Locale("pl")));
    }
    ...
    public static ToggleButton toggleButtonForKey(final String key, final Object... args) {
        ToggleButton toggleButton = new ToggleButton();
        toggleButton.textProperty().bind(createStringBinding(key, args));
        return toggleButton;
    }
